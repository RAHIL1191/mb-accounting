...
public class CustomerTransactions {
	...
	public CustomerTransactions(Long id, String firstName,  LocalDate transactionEffectiveDate, int totalAmountPending, int creditAmountReceived, int debitAmountReceived, String description,Person person) {
		super();
		this.id = id;
		this.firstName = firstName;
		this.transactionEffectiveDate = transactionEffectiveDate;
